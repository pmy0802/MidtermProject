...
public class PageResultDTO<DTO, EN> {
    ...
    public PageResultDTO(Page<EN> result, Function<EN, DTO> fn){
        ...
        totalPage = result.getTotalPages(); // 301개의 행을 갖고 있다면 전체 페이지수는 31페이지이다.
    ...
    private void makePageList(Pageable pageable){
        ...
        start = temEnd -9;
        // 삼항조건 연산자에서 조건식 true면 마지막 화면이 아닌 경우 false면 마지막 화면이라는 의미
        ...
        next = totalPage > temEnd; // 1~마지막 바로 전화면까지 true
    }
}
